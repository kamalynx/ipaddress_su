...
class IPLog(BaseLogModel):
    ...
    class Meta(BaseLogModel.Meta):
        ...
        indexes = BaseLogModel.Meta.indexes + [models.Index(fields=('address',))]
...
class DomainLog(BaseLogModel):
    ...
    view_type = models.CharField(max_length=16, choices=ViewType, verbose_name='тип представления', null=True)

    class Meta(BaseLogModel.Meta):
        verbose_name = 'Журнал доменов'
        indexes = BaseLogModel.Meta.indexes + [models.Index(fields=('name', 'view_type'))]
